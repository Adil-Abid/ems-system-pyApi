...
class Employee(models.Model):
    ...
    eobinno = models.TextField(blank=True)
    eobinnoact = models.TextField(blank=True)
    ...
    pfundamount = models.DecimalField(max_digits=18, decimal_places=0, blank=True)
...
class SecUser(models.Model):
    ...
    employeeid = models.DecimalField(max_digits=18, decimal_places=0)
